...
import br.com.gustavorodrigues.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create (@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if(taskModel.getStarAt().isAfter(taskModel.getEndAt()) ){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("A data de início deve ser menor que data de termino");
        }
    ...
    // http://localhost:8080/tasks/892347823-casdasdas
    @PutMapping("/{id}")
